...
def show_skills(skills, type):
    ...
    for skill in skills:
        st.markdown(
            f'<span class="skill-pill {color_class}">{skill}</span>',
...
def render_analyzer():
    ...
    st.markdown("""
        ...
        .input-card {
            ...
            box-shadow: 0 10px 15px -3px rgba(0,0,0,.05),
                        0 4px 6px -2px rgba(0,0,0,.03) !important;
    ...
    st.markdown(
        "Upload your resume and get professional insights in seconds."
    )
    ...
    if analyze_btn:
        ...
        if uploaded_file and job_description:
            ...
            st.warning(
                "⚠️ Please provide both a Resume and Job Description to continue."
            )